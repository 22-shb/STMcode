...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, EN1_Pin|BIN1_Pin|BIN2_Pin|AIN1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BIN1_Pin BIN2_Pin AIN1_Pin */
  GPIO_InitStruct.Pin = BIN1_Pin|BIN2_Pin|AIN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : In1_Pin In8_Pin In7_Pin In6_Pin
                           In5_Pin */
  GPIO_InitStruct.Pin = In1_Pin|In8_Pin|In7_Pin|In6_Pin
                          |In5_Pin;
