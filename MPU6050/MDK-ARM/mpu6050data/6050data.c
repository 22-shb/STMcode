...
{
    float sum_x = 0, sum_y = 0, sum_z = 0,sum_z_l = 0,sum_z_all = 0;
...
//				sum_z_l = mpu_data.gyro_z_dps;
////				sum_z = mpu_data.gyro_z_dps - sum_z_l;
////				sum_z_all += sum_z;
    }
    
    gyro_bias_x = sum_x / samples;
    gyro_bias_y = sum_y / samples;
    gyro_bias_z = sum_z / samples;//斜率a
    ///////////////////////////////////////////////////////////////////////////////////
}
